...
dammit annotate $DATA_DIR/$TEST_FILE --quick --user-databases $DATA_DIR/$TEST_PEP -o $TEST_FILE.dammit.udb 
dammit annotate $DATA_DIR/$TEST_FILE --no-rename -o $TEST_FILE.dammit.norename
